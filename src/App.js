    ...
    <div className="app-container">
      <div className="layout-container">
        ...
        <div className="parameters-container">
          ...
          <div className="app-section">
            With a confidence level of {((1 - delta) * 100).toFixed(2)}%: The
            error of the Laplace mechanism's private statistical estimate is
          ...
          {isScenarioVisible && (
            <div className="app-section scenario-section">
              <h3>Scenario:</h3>
